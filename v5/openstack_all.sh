#!/bin/bash
###############################################################################
# OpenStack Dalmatian 一键部署总脚本  v5
# 运行位置: 控制节点
# 运行用户: root
#
# 本地运行:
...
#
# 远程一键运行:
#   bash <(curl -sSL https://raw.githubusercontent.com/.../v5/openstack_all.sh) --keep
#   bash <(curl -sSL https://raw.githubusercontent.com/.../v5/openstack_all.sh)
###############################################################################
...
show_menu() {
    echo ""
    echo "╔══════════════════════════════════════════════════════════════╗"
    echo "║     OpenStack Dalmatian 一键部署 (CentOS Stream 9)  v5     ║"
    echo "╠══════════════════════════════════════════════════════════════╣"
    echo "║  模块:                                                      ║"
    for m in "${MODULES[@]}"; do
